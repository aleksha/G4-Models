...
//------------------------------------------
  ...
  G4double lFi_z =    0.500*mm;
  G4double dFiSi =   10.000*mm;


  //G4Material* steel = nist->FindOrBuildMaterial("G4_STAINLESS-STEEL");
  G4Material* SiSolid = nist->FindOrBuildMaterial("G4_Si");
  G4Material* FiSolid = nist->FindOrBuildMaterial("G4_POLYSTYRENE");
...
//------------------------------------------
  ...
  G4double l00_z = -3000.000*mm + 0.5 * lSi_z + l01_z;
  G4double l02_z =  l21_z       - 0.5 * lSi_z + dBeSi;
  G4double l03_z =  3000.000*mm - 0.5 * lSi_z + l02_z;

  G4double l81_z =  l01_z - dFiSi ;
  G4double l80_z =  l00_z - dFiSi ;
  G4double l82_z =  l02_z + dFiSi ;
  G4double l83_z =  l03_z + dFiSi ;
...
//------------------------------------------
  ...
  G4Material*  CSolid = nist->FindOrBuildMaterial("G4_C" );
...
//=====================================================================================
  ...
  G4Box* solidLV80 = new G4Box("LV80", 0.5*l_xy, 0.5*l_xy, 0.5*lFi_z);
  G4Box* solidLV81 = new G4Box("LV81", 0.5*l_xy, 0.5*l_xy, 0.5*lFi_z);
  G4Box* solidLV82 = new G4Box("LV82", 0.5*l_xy, 0.5*l_xy, 0.5*lFi_z);
  G4Box* solidLV83 = new G4Box("LV83", 0.5*l_xy, 0.5*l_xy, 0.5*lFi_z);
...
//  G4LogicalVolume* logicLV20 = new G4LogicalVolume(solidLV20 ,  CSolid, "LV20");
//  G4LogicalVolume* logicLV21 = new G4LogicalVolume(solidLV21 ,  CSolid, "LV21");
//  G4LogicalVolume* logicLV20 = new G4LogicalVolume(solidLV20 , AlSolid, "LV20");
//  G4LogicalVolume* logicLV21 = new G4LogicalVolume(solidLV21 , AlSolid, "LV21");
//  G4LogicalVolume* logicLV20 = new G4LogicalVolume(solidLV20 , TiSolid, "LV20");
//  G4LogicalVolume* logicLV21 = new G4LogicalVolume(solidLV21 , TiSolid, "LV21");
...
//  G4LogicalVolume* logicLV71 = new G4LogicalVolume(solidLV71 , BeSolid, "LV71");
  ...
  G4LogicalVolume* logicLV80 = new G4LogicalVolume(solidLV80 , FiSolid, "LV80");
  G4LogicalVolume* logicLV81 = new G4LogicalVolume(solidLV81 , FiSolid, "LV81");
  G4LogicalVolume* logicLV82 = new G4LogicalVolume(solidLV82 , FiSolid, "LV82");
  G4LogicalVolume* logicLV83 = new G4LogicalVolume(solidLV83 , FiSolid, "LV83");
  ...
  G4ThreeVector l80_pos; l80_pos.set( 0, 0, l80_z ); // Fi 1
  G4ThreeVector l81_pos; l81_pos.set( 0, 0, l81_z ); // Fi 2
  G4ThreeVector l82_pos; l82_pos.set( 0, 0, l82_z ); // Fi 3
  G4ThreeVector l83_pos; l83_pos.set( 0, 0, l83_z ); // Fi 4
  ...
  // - Fi Trackers
  new G4PVPlacement(0, l80_pos, logicLV80, "LV80", logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, l81_pos, logicLV81, "LV81", logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, l82_pos, logicLV82, "LV82", logicWorld, false, 0, checkOverlaps);
  new G4PVPlacement(0, l83_pos, logicLV83, "LV83", logicWorld, false, 0, checkOverlaps);
