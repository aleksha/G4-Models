#ifndef STLDetectorConstruction_h
#define STLDetectorConstruction_h 1
...
class STLDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    STLDetectorConstruction();
    virtual ~STLDetectorConstruction();
