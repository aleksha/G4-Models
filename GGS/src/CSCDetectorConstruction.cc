...
G4VPhysicalVolume* CSCDetectorConstruction::Construct()
{
  ...
  G4double l01_z = l00_z;
  G4double l02_z = l00_z;
  G4double l03_z = l00_z;
  G4double l04_z = l00_z;
  G4double l05_z = l00_z;

  G4double l06_z = 300.000*mm;
  G4double l07_z =   3.000*mm;
  G4double l08_z =  30.001*mm;
  G4double l09_z =   3.001*mm;
  G4double l10_z =  30.000*mm;
  G4double l11_z =   3.000*mm;
  ...
  G4LogicalVolume* logicLV00 = new G4LogicalVolume(solidLV00, steel , "LV00");
  ...
  G4LogicalVolume* logicLV10 = new G4LogicalVolume(solidLV10, ArCH4 , "LV10");
  G4LogicalVolume* logicLV11 = new G4LogicalVolume(solidLV11, ArCH4 , "LV11");
  G4LogicalVolume* logicLV12 = new G4LogicalVolume(solidLV12, w_mat , "LV12");
  G4LogicalVolume* logicLV13 = new G4LogicalVolume(solidLV13, w_mat , "LV13");
  G4LogicalVolume* logicLV14 = new G4LogicalVolume(solidLV14, w_mat , "LV14");
  G4LogicalVolume* logicLV15 = new G4LogicalVolume(solidLV15, w_mat , "LV15");
  G4LogicalVolume* logicLV16 = new G4LogicalVolume(solidLV16, w_mat , "LV16");


  G4double shft    =   10.*mm;
  G4double p_start = shft -  0.5*w_z ;
  G4double wall    = p_start + l00_z + l01_z + l02_z + l03_z + l04_z + l05_z;
  G4double argap   =    wall + l06_z + l07_z + l08_z + l09_z + l10_z + l11_z ;
  G4double dummy   = 0.002*mm;

  G4ThreeVector l00_pos; l00_pos.set(0,0,0.5*l00_z + p_start );
  G4ThreeVector l01_pos; l01_pos.set(0,0,1.5*l00_z + p_start );
  G4ThreeVector l02_pos; l02_pos.set(0,0,2.5*l00_z + p_start );
  G4ThreeVector l03_pos; l03_pos.set(0,0,3.5*l00_z + p_start );
  G4ThreeVector l04_pos; l04_pos.set(0,0,4.5*l00_z + p_start );
  G4ThreeVector l05_pos; l05_pos.set(0,0,5.5*l00_z + p_start );
  G4ThreeVector l06_pos; l06_pos.set(0,0, wall + 0.5*l06_z );
  G4ThreeVector l07_pos; l07_pos.set(0,0, wall + l06_z + 0.5*l07_z);
  G4ThreeVector l08_pos; l08_pos.set(0,0, wall + l06_z + l07_z + 0.5*l08_z);
  G4ThreeVector l09_pos; l09_pos.set(0,0, wall + l06_z + l07_z + l08_z + 0.5*l09_z);
  G4ThreeVector l10_pos; l10_pos.set(0,0, wall + l06_z + l07_z + l08_z + l09_z + 0.5*l10_z);
  G4ThreeVector l11_pos; l11_pos.set(0,0, wall + l06_z + l07_z + l08_z + l09_z + l10_z + 0.5*l11_z);

  G4ThreeVector l12_pos; l12_pos.set(0,0, argap + 0.5*dummy + shft );
  G4ThreeVector l13_pos; l13_pos.set(0,0, argap + 1.5*dummy + shft );
  G4ThreeVector l14_pos; l14_pos.set(0,0, argap + 2.5*dummy + shft );
  G4ThreeVector l15_pos; l15_pos.set(0,0, argap + 3.5*dummy + shft );
  G4ThreeVector l16_pos; l16_pos.set(0,0, argap + 4.5*dummy + shft );
