#ifndef RFZDetectorConstruction_h
#define RFZDetectorConstruction_h 1
...
class RFZDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    RFZDetectorConstruction();
    virtual ~RFZDetectorConstruction();
