...
//------------------------------------------------------------------------------
ZMSSteppingAction::ZMSSteppingAction(ZMSEventAction* eventAction)
...
//------------------------------------------------------------------------------
ZMSSteppingAction::~ZMSSteppingAction(){
  myOUT.close(); }
//------------------------------------------------------------------------------
void ZMSSteppingAction::UserSteppingAction(const G4Step* step)
{
  if ( !fLV00 || !fLV01 || !fLV02 || !fLV03 || !fLV04 ||
                 !fLV05 || !fLV06 || !fLV07 || !fLV08 || !fLV09 ||
       !fLV10 || !fLV11 || !fLV12 || !fLV13 || !fLV14 || !fLV15 || !fLV16 ){
    const ZMSDetectorConstruction* detectorConstruction
      = static_cast<const ZMSDetectorConstruction*>
