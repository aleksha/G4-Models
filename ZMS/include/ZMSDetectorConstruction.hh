#ifndef ZMSDetectorConstruction_h
#define ZMSDetectorConstruction_h 1
...
class ZMSDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    ZMSDetectorConstruction();
    virtual ~ZMSDetectorConstruction();
